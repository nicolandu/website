...
```plain,name=Faisceaux possibles
  X
  |
 |^|
 | |
...
{{ admonition(type="warning", text="Le texte qui suit est un divulgâcheur. Si vous avez l'intention de relever le défi, allez-y, et revenez après! Sinon, cliquez sur le texte pour le révéler.") }}
