...
[Le défi Advent of Code d'aujourd'hui](https://adventofcode.com/2025/day/7) impliquait de calculer l'union d'immenses intervalles de nombres.
...
{{ aside(text="Ici, *Implémenter* est utilisé dans un sens plutôt large...") }}

 «Implémenter» une stratégie efficace était aussi simple que ça:
...
La morale de l'histoire? Travailler plus intelligement, pas plus fort.
