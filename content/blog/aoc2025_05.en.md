...
I first thought about the algorithms the challenge would entail. I *knew* that a naïve solution, such as a simple vector with all elements really wouldn't cut it (who has enough memory for 2<sup>50</sup> entries?), and getting any ad-hoc implementation to work right was guaranteed to be massive a pain in the neck.
...
"Implementing[^1]" an efficient strategy was as simple as this:
...
[^1]: Here, *implementing* is used in a rather loose sense...
